...
export default function Portfolio() {
  ...
  const downloadResume = () => {
    ...
    link.href = `/${fileName}`; // Make sure it's in /public
  ...
  return (
    <main className="bg-white text-gray-800">
      ...
      <section id="home" className="flex flex-col items-center justify-center h-screen text-center px-4 bg-gradient-to-r from-blue-50 to-blue-100">
        ...
        <p className="text-xl mb-6">Full Stack Developer | MERN | NEXT.js | REACT.js</p>
        ...
        <div className="flex space-x-4 mt-6">
          <Link href="https://github.com/sandeep9062" target="_blank" rel="noopener noreferrer">
            <Github className="hover:text-blue-600" />
          </Link>
          <Link href="https://www.linkedin.com/in/sandeep-saini-a6309924a/" target="_blank" rel="noopener noreferrer">
            <Linkedin className="hover:text-blue-600" />
          </Link>
          <Link href="mailto:sandeep2001saini01@gmail.com">
            <Mail className="hover:text-blue-600" />
          </Link>
        </div>

        <Button onClick={downloadResume} className="px-4 py-2 mt-12 bg-blue-50 text-black rounded-md hover:bg-blue-100" variant="outline">
          Download Resume!
        </Button>
      </section>
          ...
          {projects.map((project) => (
            <div key={project.name} className="bg-white rounded-xl shadow-md overflow-hidden hover:scale-105 transition-transform duration-300">
              ...
              <div className="p-6">
                ...
                <Link href={project.link} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline text-sm">
                  View Project →
                </Link>
              </div>
            </div>
